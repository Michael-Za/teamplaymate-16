...
const config = {
  ...
  GOOGLE_CALLBACK_URL: process.env.GOOGLE_CALLBACK_URL || 'http://localhost:3003/api/v1/auth/google/callback',
  ...
  AI_ASSISTANT_BACKEND_URL: process.env.AI_ASSISTANT_BACKEND_URL || 'http://localhost:5000',
