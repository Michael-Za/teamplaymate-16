...
class MockRedisService {
  ...
  async initialize() {
    // This is a no-op for the mock service as it is initialized in the constructor.
    // This method is here to maintain a consistent service initialization interface.
    logger.info('Mock Redis service explicitly initialized.');
