...
console.log('=== SERVER.JS LOADED - VERSION 2025-11-25 (ES Modules) ===');
...
class Server {
  ...
  async initializeServices() {
    ...
    try {
      ...
      this.teamsRoutes = teamsRoutes;
      this.playersRoutes = playersRoutes;
      this.matchesRoutes = matchesRoutes;
      this.analyticsRoutes = analyticsRoutes;
      this.trainingRoutes = trainingRoutes;
      this.chatRoutes = chatRoutes;
      this.subscriptionsRoutes = subscriptionsRoutes;
      this.reportsRoutes = reportsRoutes;
      this.aiChatRoutes = aiChatRoutes;
      this.aiAssistantRoutes = aiAssistantRoutes;
      this.emailRoutes = emailRoutes;
      this.notificationsRoutes = notificationsRoutes;
