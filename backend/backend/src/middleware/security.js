...
const securityCheck = securityMiddleware.securityCheck();
const bruteForceProtection = securityMiddleware.bruteForceProtection();
const inputSanitization = securityMiddleware.inputSanitization();
const sqlInjectionProtection = securityMiddleware.sqlInjectionProtection();
const xssProtection = securityMiddleware.xssProtection();
const fileUploadSecurity = securityMiddleware.fileUploadSecurity();
const securityLogging = securityMiddleware.securityLogging();
const enhancedCORS = securityMiddleware.enhancedCORS();
const authLimiter = securityMiddleware.getAuthLimiter();
const apiLimiter = securityMiddleware.getApiLimiter();
const speedLimiter = securityMiddleware.getSpeedLimiter();
