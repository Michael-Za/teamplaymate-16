...
// Only import passport/google strategy if environment variables are set
let passport;
try {
  passport = require('../services/google-strategy');
} catch (error) {
...
exports.resetPassword = async (req, res, next) => {
  ...
  createSendToken(user, res, 'Password updated successfully!');
};
