...
const translations = {
  es: {
    ...
    'stats.assists.total': 'Asistencias',
    'stats.shots.goal': 'Tiros al Arco',
    'stats.shots.out': 'Tiros Desviados',
    'stats.balls.recovered': 'Balones Recuperados',
    'stats.duels.won': 'Duelos Ganados',
    'stats.saves': 'Atajadas',
    ...
    'positionStats': 'Estadísticas por Posición',
    ...
    'sidebar.advanced.analytics': 'Análisis Avanzado',
    ...
    'dataManagement.subtitle': 'Sistema integral de gestión de datos de jugadores y clubes',
    'dataManagement.importData': 'Importar Datos',
    'dataManagement.exportData': 'Exportar Datos',
    'dataManagement.addNew': 'Agregar Nuevo',
    'dataManagement.totalPlayers': 'Total Jugadores',
    'dataManagement.activeContracts': 'Contratos Activos',
    'dataManagement.avgRating': 'Calificación Promedio',
    'dataManagement.totalGoals': 'Goles Totales',
    'dataManagement.players': 'Jugadores',
    'dataManagement.clubs': 'Clubes',
    'dataManagement.analytics': 'Análisis',
    'dataManagement.reports': 'Informes',
    'dataManagement.search.placeholder': 'Buscar jugadores por nombre, posición o nacionalidad...',
    'dataManagement.filter.allStatus': 'Todos los Estados',
    'dataManagement.filter.active': 'Activo',
    'dataManagement.filter.injured': 'Lesionado',
    'dataManagement.filter.suspended': 'Suspendido',
    'dataManagement.sort.name': 'Ordenar por Nombre',
    'dataManagement.sort.rating': 'Ordenar por Calificación',
    'dataManagement.sort.goals': 'Ordenar por Goles',
    'dataManagement.sort.age': 'Ordenar por Edad',
    'dataManagement.sort.marketValue': 'Ordenar por Valor de Mercado',
    'dataManagement.selected': 'seleccionados',
    'dataManagement.exportSelected': 'Exportar Seleccionados',
    'dataManagement.archiveSelected': 'Archivar Seleccionados',
    'dataManagement.deleteSelected': 'Eliminar Seleccionados'
  },
  en: {
    // Navigation
    'nav.home': 'Home',
    ...
    'stats.shots.out': 'Shots Off Goal',
    ...
    // Data Management
    'dataManagement.title': 'Data Management Center',
    'dataManagement.subtitle': 'Comprehensive player and club data management system',
    'dataManagement.importData': 'Import Data',
    'dataManagement.exportData': 'Export Data',
    'dataManagement.addNew': 'Add New',
    'dataManagement.totalPlayers': 'Total Players',
    'dataManagement.activeContracts': 'Active Contracts',
    'dataManagement.avgRating': 'Avg Rating',
    'dataManagement.totalGoals': 'Total Goals',
    'dataManagement.players': 'Players',
    'dataManagement.clubs': 'Clubs',
    'dataManagement.analytics': 'Analytics',
    'dataManagement.reports': 'Reports',
    'dataManagement.search.placeholder': 'Search players by name, position, or nationality...',
    'dataManagement.filter.allStatus': 'All Status',
    'dataManagement.filter.active': 'Active',
    'dataManagement.filter.injured': 'Injured',
    'dataManagement.filter.suspended': 'Suspended',
    'dataManagement.sort.name': 'Sort by Name',
    'dataManagement.sort.rating': 'Sort by Rating',
    'dataManagement.sort.goals': 'Sort by Goals',
    'dataManagement.sort.age': 'Sort by Age',
    'dataManagement.sort.marketValue': 'Sort by Market Value',
    'dataManagement.selected': 'selected',
    'dataManagement.exportSelected': 'Export Selected',
    'dataManagement.archiveSelected': 'Archive Selected',
