...
<<<<<<< HEAD
  const handleAddPlayerAction = () => {
    ...
    const now = new Date();
    const newAction = {
      playerId: Date.now().toString(), // In a real app, this would be an actual player ID
      playerName: actionForm.playerName,
      actionType: actionForm.actionType,
      matchId: Date.now().toString(), // In a real app, this would be an actual match ID
      matchName: actionForm.matchName,
      timestamp: now.toISOString(),
      minute: now.getMinutes(), // Use current minute instead of undefined
      second: now.getSeconds(), // Use current second instead of undefined
      position: {
        x: actionForm.positionX,
        y: actionForm.positionY,
    ...
    addPlayerAction && addPlayerAction(newAction);
    updatePlayerStats(newAction.playerId, newAction.playerName, newAction.actionType);
    ...
    toast.success('Player action recorded successfully');
  };

  const handleDeletePlayerAction = (id: string) => {
...
>>>>>>> 5b1c6eafdf9968ae53e6d141d90a040247079721
  ...
  return (
    <div className="h-screen overflow-hidden p-6 bg-white">
                ...
                <div className="space-y-2">
                  ...
                  {allTags.length > 0 && (
                    <select
                      ...
                      className="w-full px-3 py-2 rounded-md border bg-white border-gray-300 text-gray-900"
                    >
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs mt-1 line-clamp-2 break-words text-gray-600">
                          {note.content}
                        </p>
                        {note.tags.length > 0 && (
              ...
              {isEditing ? (
                ...
                <>
                  ...
                  <CardContent className="flex-1 overflow-y-auto min-h-0">
                    <div className="whitespace-pre-wrap text-gray-700 h-full overflow-y-auto">
                ...
                <CardContent 
                  className="flex flex-col items-center justify-center flex-1 cursor-pointer transition-all duration-200 hover:bg-gray-50 rounded-lg border-2 border-dashed border-gray-300 hover:border-gray-400 min-h-0 overflow-hidden"
